...
public class SpringSongWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SpringSongWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SpringSongWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SpringSongWLAIW/InitOutcome.xml").getDocumentElement();
